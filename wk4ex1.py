...
def reverse(filename):
    """ reverse speelt een geluidsbestand, filename, achterstevoren af
    """
    print("Het originele geluid afspelen...")
    play(filename)
    ...
    print("Nieuw geluid berekenen...") #draait lijst om
    newsamps = samps[::-1]
    newsr = sr
    new_sound_data = [newsamps, newsr]
...
def volume(filename, scale_factor):
    """volume van de file gaat steeds met de scale_factor omhoog
    """
    print("Het originele geluid afspelen...")
    play(filename)
    ...
    print("Nieuw geluid berekenen...") #mbv scalefactor
    newsamps = [scale_factor * x for x in sound_data] #for???
    newsr = sr
    new_sound_data = [newsamps, newsr]
